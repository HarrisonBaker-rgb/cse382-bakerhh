...
public class Participant {
	...
	public Participant(String str)
	{
		...
		Age = toks[3] != "NA" ? int.Parse(toks[3]) : -1;
		Country = toks[6];
		if (rg.IsMatch(toks[9]))
		{
		...
		Sport = toks[12];
		Event = toks[13];
		Medal = toks[14] == "NA" ? MedalType.None : toks[14] == "Bronze" ? MedalType.Bronze :
				toks[14] == "Silver" ? MedalType.Silver : MedalType.Gold;
	}
}